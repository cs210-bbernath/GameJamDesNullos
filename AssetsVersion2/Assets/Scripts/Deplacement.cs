...
public class Deplacement : MonoBehaviour
{
    ...
    public void changeTheBall(){
        /*
        if (((transform.position.x < otherPlayer.transform.position.x + marging) || (transform.position.x > otherPlayer.transform.position.x - marging))
            && ((transform.position.y < otherPlayer.transform.position.y + marging) || (transform.position.y > otherPlayer.transform.position.y - marging)) 
            && isDashing){
            getTheBall();
